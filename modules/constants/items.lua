...
local brick_holding_offset = vmath.vector3(-6.0, -4.0, 1.0)
local brick_holding_scale = vmath.vector3(0.25, 0.25, 1.0)

local wood_plank_holding_offset = vmath.vector3(-6.0, -4.0, 1.0)
local wood_plank_holding_scale = vmath.vector3(0.75, 0.75, 1.0)

local pickaxe_holding_offset = vmath.vector3(-2.0, -1.0, 1.0)
local pickaxe_holding_scale = vmath.vector3(0.75, 0.75, 1.0)
...
ITEMS.NONE = {
	...
	holding_scale = vmath.vector3(1.0, 1.0, 1.0),
	stack_size = 0
}
...
ITEMS.DIRT = {
	...
	name = 'dirt',
	display_name = 'Dirt',
	holding_offset = brick_holding_offset,
	holding_scale = brick_holding_scale,
	stack_size = 64
}
ITEMS.STONE = {
	id = 010002,
...
ITEMS.WOOD_PLANKS = {
	...
	holding_offset = wood_plank_holding_offset,
	holding_scale = wood_plank_holding_scale,
	stack_size = 64
}
ITEMS.FURNACE = {
	id = 010013,
...
ITEMS.STONE_PICKAXE = {
	...
	holding_offset = pickaxe_holding_offset,
	holding_scale = pickaxe_holding_scale,
	mining_power = 1,
	stack_size = 1
}
...
ITEMS.ALL_ITEMS[ITEMS.IRON_PICKAXE.id] = ITEMS.IRON_PICKAXE
...
ITEMS.TOOL[ITEMS.IRON_PICKAXE.id] = ITEMS.IRON_PICKAXE
...
ITEMS.CRAFTABLE[ITEMS.IRON_PICKAXE.id] = ITEMS.IRON_PICKAXE
