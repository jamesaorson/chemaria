...
MESSAGES.ANIMATION_DONE = hash('animation_done')
...
MESSAGES.SPAWN_BACKGROUND_BACK = hash('spawn_background_back')
MESSAGES.SPAWN_BACKGROUND_FRONT = hash('spawn_background_front')
MESSAGES.SPAWN_BACKGROUND_MIDDLE = hash('spawn_background_middle')
MESSAGES.SPAWN_BACKGROUND_UNDERGROUND = hash('spawn_background_udnerground')
